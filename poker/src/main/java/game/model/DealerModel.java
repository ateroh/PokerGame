...
public class DealerModel {
    ...
    public void dealCards(List<String> players) throws InterruptedException {
        ...
        for (String p : players) {
            ...
            gameSpace.put("holeCards", p, card1.getSuit(), card1.getRank(), card2.getSuit(), card2.getRank()); // used in endHand to find player cards.
        }
    }
    ...
    public void dealFlop(List<String> players) {
        ...
        try {
            ...
            gameSpace.put("communityFlop", card1.getSuit(), card1.getRank(), card2.getSuit(), card2.getRank(), card3.getSuit(), card3.getRank());
    ...
    public void dealTurn(List<String> players) throws InterruptedException {
        ...
        gameSpace.put("communityTurn", card.getSuit(), card.getRank());
    }
    ...
    public void dealRiver(List<String> players) throws InterruptedException {
        ...
        gameSpace.put("communityRiver", card.getSuit(), card.getRank());
    }
    ...
    public void resetForNewHand() throws InterruptedException {
        deck.reset();
    }    
}
